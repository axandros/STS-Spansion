...
public class ArchaicFuelPower extends AbstractPower implements CloneablePowerInterface {
    public AbstractCreature source;

    public static final String POWER_ID = Spansion.makeID(ArchaicFuelPower.class.getSimpleName());
    ...
    public ArchaicFuelPower(final AbstractCreature owner, final AbstractCreature source, final int amount) {
        name = NAME;
        ID = POWER_ID;
    ...
    public AbstractPower makeCopy() {
        return new ArchaicFuelPower(owner, source, amount);
    }
}